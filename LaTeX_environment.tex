...
\section{TeX Live導入\index{TeX Live}}
...
\subsection{スニペット導入}
\subsubsection*{スニペットとは\index{スニペット}}
...
まずVSCode 上の拡張機能からcloudlatex の拡張機能をインストールする。次に自分のcloudlatexのマイページから右上のユーザー名をクリックしてプルダウンを開き「プラグイン連携」をクリックする。次にそこで生成されるトークンを二つコピーする。
